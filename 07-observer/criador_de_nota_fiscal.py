...
##
# Builder de Notas Fiscais 
# Obs: Apenas representativo, o Python soluciona isso nativamente
##
class Criador_de_nota_fiscal(object):
	...
	def com_data_de_emissao(self, data_de_emissao=date.today()):
	...
	##
	# Retorna uma instância da Nota Fiscal construída 
	# pelo Builder
	##
	def constroi(self):
		...
		if self.__data_de_emissao is None:
			raise Exception("Data deve ser preenchido")
